...
HELP_GROUPS: List[HelpGroup] = [
    {
        ...
        "items": [
            ...
            {"cmd": "{prefix}原神日历 / {prefix}原神日历列表", "desc": "查看原神活动与祈愿日历，对应 miao-plugin #日历"},
    ...
    },
    {
        "group": "单角色详情",
        "items": [
            {"cmd": "{prefix}原神雷神面板 [UID]", "desc": "查看单角色完整图片面板，对齐 miao-plugin #雷神面板"},
            {"cmd": "{prefix}原神雷神详情 / {prefix}原神雷神详细 [UID]", "desc": "展示属性、武器、天赋、命座与圣遗物信息"},
            {"cmd": "{prefix}原神雷神圣遗物 [UID]", "desc": "查看单角色圣遗物评分详情，对齐 #雷神圣遗物"},
            {"cmd": "{prefix}原神圣遗物列表 [UID]", "desc": "按评分查看公开角色圣遗物列表图"},
            {"cmd": "{prefix}原神雷神伤害 [UID]", "desc": "查看当前面板下的通用伤害估算，对齐 #雷神伤害"},
            {"cmd": "{prefix}原神面板图 <UID> [角色]", "desc": "按 UID 与角色名直接渲染单角色面板图"},
            {"cmd": "{prefix}原神圣遗物评分 <UID> [角色]", "desc": "按 UID 与角色名直接查看圣遗物评分"},
            {"cmd": "{prefix}原神伤害计算 <UID> [角色]", "desc": "按 UID 与角色名直接查看伤害估算"},
        ],
    },
    {
        "group": "设置命令",
...
STAR_RAIL_HELP_GROUPS: List[HelpGroup] = [
    {
        ...
        "items": [
            ...
            {"cmd": "{prefix}崩铁更新日志", "desc": "查看崩铁功能最近更新"},
            {"cmd": "{prefix}登录", "desc": "米游社 App 扫码登录，保存原神/崩铁共用 Cookie，并自动绑定可识别 UID"},
            {"cmd": "{prefix}登录 <米游社Cookie>", "desc": "手动保存米游社登录 Cookie"},
            {"cmd": "{prefix}签到 [UID]", "desc": "使用已保存 Cookie 执行原神与崩铁每日签到"},
            {"cmd": "{prefix}查看登录 / {prefix}删除登录", "desc": "查看或删除本地米游社登录信息"},
            {"cmd": "{prefix}崩铁设置uid <UID>", "desc": "绑定星铁 UID，并与喵喵登录保存的崩铁角色联动"},
            {"cmd": "{prefix}崩铁版本", "desc": "查看崩铁功能迁移版本（规划）"},
            {"cmd": "{prefix}崩铁日历 / {prefix}崩铁日历列表", "desc": "星穹铁道活动与跃迁日历，对应 miao-plugin #星铁日历"},
        ],
    },
    {
        "group": "角色面板",
    ...
    },
    {
        ...
        "items": [
            ...
            {"cmd": "{prefix}崩铁黄泉伤害 [UID]", "desc": "查看当前面板下的通用伤害估算，对齐 miao-plugin #角色伤害"},
        ],
    },
    {
        "group": "排行与练度",
